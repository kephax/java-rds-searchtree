...
{
	/* /// ATTRIBUTES /// */
	private SearchTree<K,V> myLeft;
	private SearchTree<K,V> myRight;
	private K key;
	private V item;
	...
	public SearchTree( SearchTree<K, V> left, SearchTree<K, V> right )
	{
		myLeft = left;
		myRight = right;
	}
	...
	{ 
		if ( isEmpty() )
		{
			...
			myLeft = new SearchTree<K, V>();
			myRight = new SearchTree<K, V>();
		}
		else
		{
	...
	/* /// getLargest /////////////////////////////////// */
	public SearchTree<K, V> getLargest()
	{
		if( ( isEmpty() )||( myRight.isEmpty() ))
		{
			return this;
	...
	/*/// getKleinste /////////////////////////////////// */
	public SearchTree<K, V> getSmallest()
	{
